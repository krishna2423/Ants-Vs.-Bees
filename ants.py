...
class Ant(Insect):
    ...
    def double(self):
        ...
        while current_place != None: 
            if isinstance(current_place.ant, ContainerAnt) and current_place.ant.ant_contained != None and current_place.ant.ant_contained.doubled == False: 
                current_place.ant.ant_contained.damage *= 2
                current_place.ant.ant_contained.doubled = True
                if type(current_place.ant) == TankAnt and current_place.ant.doubled == False: 
                    current_place.ant.damage *=2 
                    current_place.ant.doubled = True
            elif current_place.ant != None: 
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while place != None and place.is_hive == False: 
            if place.bees != [] and current_place <= self.upper_bound and current_place >= self.lower_bound:
